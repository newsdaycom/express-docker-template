/**
 * Optional SQS polling helper for services that consume queue messages.
 *
 * Purpose:
 *   Provides a reusable poller and message wrapper that generated services can
 *   keep when they need AWS SQS consumption or delete when they are HTTP-only.
 *
 * Environment:
